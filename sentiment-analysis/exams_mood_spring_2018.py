...
# week before is april 25-may 1
# Exams were may 2 to may 8
# week after was may 9 - may 15
start_date = datetime(2018, 4, 19, 4, 0)
stop_date = datetime(2018, 5, 23, 4, 0)
VADER_list = []
TextBlob_list = []
date_list = []
...
plt.title('Spyral Mood (Average Daily Score) Before, During and After Spring Exams 2018')
plt.xlabel('Date')
